...
public class IoOperations {
	...
	public ArrayList<Medical> medicalCheck(Medical medical) throws OHException
	{
		...
		List<Object> parameters = Collections.<Object>singletonList(medical.getDescription());
	...
	/**
	 * Checks if the specified {@link Medical} has similar copies.
	 * @param medical - the medical to check.
	 * @return <code>true</code> if exists, <code>false</code> otherwise.
	 * @throws OHException if an SQL error occurs during the check.
	 */
	...
	{
		boolean result = false;
		List<Object> parameters = Collections.<Object>singletonList(medical.getProd_code());
