...
public class GenericReportUserInDate {
	...
	public GenericReportUserInDate(String fromDate, String toDate, String aUser, String jasperFileName) {
		new GenericReportUserInDate(fromDate, toDate, aUser, jasperFileName, true, false, false);
	}
	
	public GenericReportUserInDate(String fromDate, String toDate, String jasperFileName, boolean receiptPrinter) {
		new GenericReportUserInDate(fromDate, toDate, "%", jasperFileName, true, receiptPrinter, true);
	}
	
	public GenericReportUserInDate(String fromDate, String toDate, String aUser, String jasperFileName, boolean receiptPrinter) {
		new GenericReportUserInDate(fromDate, toDate, aUser, jasperFileName, true, receiptPrinter, true);
	}
	
	public  GenericReportUserInDate(String fromDate, String toDate, String aUser, String jasperFileName, boolean show, boolean receiptPrinter, boolean askForPrint) {
		try{
			...
			if (receiptPrinter) {
				...
				new PrintReceipt(jasperFileName, parameters, conn);
