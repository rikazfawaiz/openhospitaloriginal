...
//		if (!typeBox.getSelectedItem().equals(MessageBundle.getMessage("angal.medicalstock.all"))) {
//			
//		} else {
//			jTableTotal.getModel().setValueAt("", 0, 11);
//			jTableTotal.getModel().setValueAt(MessageBundle.getMessage("angal.common.notapplicable"), 0, 12);
//		}
