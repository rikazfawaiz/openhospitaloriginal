...
public class AgeTypeBrowser extends ModalJFrame {
	...
	private String[] pColums = { MessageBundle.getMessage("angal.common.codem"), MessageBundle.getMessage("angal.agetype.from"), MessageBundle.getMessage("angal.agetype.to"),
