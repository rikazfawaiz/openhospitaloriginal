...
public class MedicaldsrstockmovTypeBrowser extends ModalJFrame implements MedicaldsrstockmovTypeListener{
	...
	private String[] pColums = { MessageBundle.getMessage("angal.common.codem"), MessageBundle.getMessage("angal.common.descriptionm"), MessageBundle.getMessage("angal.medstockmovtype.typem")};
