...
public class ExamBrowser extends ModalJFrame{
	...
	private String[] pColums = { MessageBundle.getMessage("angal.common.codem"), MessageBundle.getMessage("angal.exa.typem"), MessageBundle.getMessage("angal.common.descriptionm") , MessageBundle.getMessage("angal.exa.procm") , MessageBundle.getMessage("angal.exa.defaultm") };
	...
	public ExamBrowser() {
		...
		buttonDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				message.append(MessageBundle.getMessage("angal.exa.deletefolowingexam")).append(": ");
				message.append("\n").append(MessageBundle.getMessage("angal.common.code")).append("= ").append(e.getCode());
				message.append("\n").append(MessageBundle.getMessage("angal.common.description")).append(" = ");
				message.append(e.getDescription()).append("?");
