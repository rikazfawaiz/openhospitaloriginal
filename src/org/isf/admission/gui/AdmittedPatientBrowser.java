...
public class AdmittedPatientBrowser extends ModalJFrame implements
	...
	public AdmittedPatientBrowser() {
		...
		if (!GeneralData.ENHANCEDSEARCH) {//qqq
	...
	private JScrollPane getScrollPane() {
		table = new JTable(new AdmittedPatientBrowserModel(null));//qqq
	...
	private void filterPatient(String key) {//qqq
