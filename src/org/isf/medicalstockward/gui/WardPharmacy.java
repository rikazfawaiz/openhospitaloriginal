...
public class WardPharmacy extends ModalJFrame implements 
	...
	private String[] columsOutcomes = { MessageBundle.getMessage("angal.common.date"), MessageBundle.getMessage("angal.medicalstockward.patient"),
			...
			MessageBundle.getMessage("angal.medicalstockward.medical"), MessageBundle.getMessage("angal.common.quantity") };
	...
	private String[] columsDrugs = { MessageBundle.getMessage("angal.medicalstockward.medical"), MessageBundle.getMessage("angal.common.quantity") };
